...
@section('content')
    <div class="container" style="margin-top: 150px; color: red" c>
        <div class="row" style="color: red">
            ...
            <div class="col-6" style="position: relative;bottom: 80px;">
                <h3 class="text-center" style="color: black; position: relative;top: 70px;">Sign up and join now</h3>
                <form action="{{ route('PostLogin') }}" method="post" style="position: relative;top: 80px">
                    ...
                    @csrf
                        <div  style="margin-bottom: 16px">
                            <label style="color: #1a1ae8 ; margin-bottom: 15px;" >username:</label>
                            <input class="form-control" name="username" type="email" style="border: none;background-color:rgba(191,202,210,1)" placeholder="enter username">
                            @error('username')
